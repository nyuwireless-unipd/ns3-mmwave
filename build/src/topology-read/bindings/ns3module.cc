...
static PyMethodDef topology_read_TracedValueCallback_functions[] = {
    {NULL, NULL, 0, NULL}
};
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef topology_read_TracedValueCallback_moduledef = {
    PyModuleDef_HEAD_INIT,
    "topology_read.TracedValueCallback",
    NULL,
    -1,
    topology_read_TracedValueCallback_functions,
};
#endif

static PyObject *
inittopology_read_TracedValueCallback(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&topology_read_TracedValueCallback_moduledef);
    #else
    m = Py_InitModule3((char *) "topology_read.TracedValueCallback", topology_read_TracedValueCallback_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
PyObject *
PyNs3TopologyReader__PythonHelper::_wrap_DoInitialize(PyNs3TopologyReader *self)
{
    PyObject *py_retval;
    PyNs3TopologyReader__PythonHelper *helper = dynamic_cast< PyNs3TopologyReader__PythonHelper* >(self->obj);
...
void
PyNs3TopologyReader__PythonHelper::DoInitialize()
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::Object *self_obj_before;
...
_wrap_PyNs3TopologyReader__tp_init(PyNs3TopologyReader *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (Py_TYPE(self) != &PyNs3TopologyReader_Type)
    {
...
PyObject *
PyNs3InetTopologyReader__PythonHelper::_wrap_DoInitialize(PyNs3InetTopologyReader *self)
{
    PyObject *py_retval;
    PyNs3InetTopologyReader__PythonHelper *helper = dynamic_cast< PyNs3InetTopologyReader__PythonHelper* >(self->obj);
...
void
PyNs3InetTopologyReader__PythonHelper::DoInitialize()
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::Object *self_obj_before;
...
_wrap_PyNs3InetTopologyReader__tp_init(PyNs3InetTopologyReader *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (Py_TYPE(self) != &PyNs3InetTopologyReader_Type)
    {
...
PyObject *
PyNs3OrbisTopologyReader__PythonHelper::_wrap_DoInitialize(PyNs3OrbisTopologyReader *self)
{
    PyObject *py_retval;
    PyNs3OrbisTopologyReader__PythonHelper *helper = dynamic_cast< PyNs3OrbisTopologyReader__PythonHelper* >(self->obj);
...
void
PyNs3OrbisTopologyReader__PythonHelper::DoInitialize()
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::Object *self_obj_before;
...
_wrap_PyNs3OrbisTopologyReader__tp_init(PyNs3OrbisTopologyReader *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (Py_TYPE(self) != &PyNs3OrbisTopologyReader_Type)
    {
...
PyObject *
PyNs3RocketfuelTopologyReader__PythonHelper::_wrap_DoInitialize(PyNs3RocketfuelTopologyReader *self)
{
    PyObject *py_retval;
    PyNs3RocketfuelTopologyReader__PythonHelper *helper = dynamic_cast< PyNs3RocketfuelTopologyReader__PythonHelper* >(self->obj);
...
void
PyNs3RocketfuelTopologyReader__PythonHelper::DoInitialize()
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::Object *self_obj_before;
...
_wrap_PyNs3RocketfuelTopologyReader__tp_init(PyNs3RocketfuelTopologyReader *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (Py_TYPE(self) != &PyNs3RocketfuelTopologyReader_Type)
    {
...
MOD_INIT(topology_read)
{
    ...
    submodule = inittopology_read_TracedValueCallback();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);

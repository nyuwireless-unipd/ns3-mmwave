...
static PyMethodDef PyNs3ParallelCommunicationInterface_methods[] = {
    {(char *) "IsEnabled", (PyCFunction) _wrap_PyNs3ParallelCommunicationInterface_IsEnabled, METH_NOARGS, NULL },
    {(char *) "GetSystemId", (PyCFunction) _wrap_PyNs3ParallelCommunicationInterface_GetSystemId, METH_NOARGS, NULL },
    {(char *) "GetSize", (PyCFunction) _wrap_PyNs3ParallelCommunicationInterface_GetSize, METH_NOARGS, NULL },
    {(char *) "Disable", (PyCFunction) _wrap_PyNs3ParallelCommunicationInterface_Disable, METH_NOARGS, NULL },
    {(char *) "SendPacket", (PyCFunction) _wrap_PyNs3ParallelCommunicationInterface_SendPacket, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "Destroy", (PyCFunction) _wrap_PyNs3ParallelCommunicationInterface_Destroy, METH_NOARGS, NULL },
    {NULL, NULL, 0, NULL}
};
...
static PyObject*
_wrap_PyNs3ParallelCommunicationInterface__tp_richcompare (PyNs3ParallelCommunicationInterface *PYBINDGEN_UNUSED(self), PyNs3ParallelCommunicationInterface *other, int opid)
{
    
    if (!PyObject_IsInstance((PyObject*) other, (PyObject*) &PyNs3ParallelCommunicationInterface_Type)) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }
    switch (opid)
...
PyTypeObject PyNs3ParallelCommunicationInterface_Type = {
    ...
    (richcmpfunc)_wrap_PyNs3ParallelCommunicationInterface__tp_richcompare,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */

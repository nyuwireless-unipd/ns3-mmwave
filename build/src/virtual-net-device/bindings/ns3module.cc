...
_wrap_PyNs3VirtualNetDevice_Receive(PyNs3VirtualNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyObject_IsInstance(destination, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Ipv4Address, Ipv6Address, Mac48Address), not %s", Py_TYPE(destination)->tp_name);
        return NULL;
    }

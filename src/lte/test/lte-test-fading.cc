...
LteFadingTestCase::LteFadingTestCase(Ptr<BuildingsMobilityModel> m1,
                                     Ptr<BuildingsMobilityModel> m2,
                                     double refValue,
                                     std::string name)
...
LteFadingTestCase::DoRun(void)
{
    ...
    //
    //   /**
    //   * TX signal #1: Power Spectral Density (W/Hz) of the signal  = [0 0] dBm and BW = [20 22]
    //   MHz
    //   */
...
LteFadingTestCase::GetFadingSample()
{
    ...
    outPsd1 = m_fadingModule->CalcRxPowerSpectralDensity(inPsd1, m_node1, m_node2);
    (*outPsd1)[0] =
        (10 * std::log10(180000 * (*outPsd1)[0])) - (10 * std::log10(180000 * (*inPsd1)[0]));
    (*outPsd1)[1] =
        (10 * std::log10(180000 * (*outPsd1)[1])) - (10 * std::log10(180000 * (*inPsd1)[1]));

    ...
    : TestSuite("lte-pss-ff-mac-scheduler", SYSTEM)
{
    ...
    // byte/sec std::vector<double> dist2; dist2.push_back (0);       // User 0 distance --> MCS 28
    ...
    // AddTestCase (new LenaPssFfMacSchedulerTestCase2
    // (dist2,estThrPssDl2,packetSize2,1,errorModel), TestCase::QUICK);
    ...
    // 232000, 332000] byte/sec std::vector<double> dist3; dist3.push_back (0);    // User 0
    // distance --> MCS 28 dist3.push_back (4800);    // User 1 distance --> MCS 22 dist3.push_back
    // (6000);    // User 2 distance --> MCS 20 std::vector<uint16_t> packetSize3;
    ...
    // AddTestCase (new LenaPssFfMacSchedulerTestCase2
    // (dist3,estThrPssDl3,packetSize3,1,errorModel), TestCase::QUICK);
}

...
{
    static TypeId tid =
        TypeId("ns3::EpcMme").SetParent<Object>().SetGroupName("Lte").AddConstructor<EpcMme>();
    return tid;
}
...
void
EpcMme::DoInitialContextSetupResponse(uint64_t mmeUeS1Id,
                                      uint16_t enbUeS1Id,
...
void
EpcMme::DoErabReleaseIndication(
    uint64_t mmeUeS1Id,
    uint16_t enbUeS1Id,

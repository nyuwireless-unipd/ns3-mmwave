...
class RadioBearerStatsConnector
{
  public:
     ...
     * \param rnti
     */
    static void NotifyConnectionSetupUe(RadioBearerStatsConnector* c,
                                        std::string context,
                                        uint64_t imsi,
                                        uint16_t cellid,
                                        uint16_t rnti);
     ...
     * \param rnti
     */
    static void NotifyConnectionReconfigurationUe(RadioBearerStatsConnector* c,
                                                  std::string context,
                                                  uint64_t imsi,
                                                  uint16_t cellid,
                                                  uint16_t rnti);
     ...
     * \param targetCellId
     */
    static void NotifyHandoverStartUe(RadioBearerStatsConnector* c,
                                      std::string context,
                                      uint64_t imsi,
                                      uint16_t cellid,
                                      uint16_t rnti,
     ...
     * \param rnti
     */
    static void NotifyHandoverEndOkUe(RadioBearerStatsConnector* c,
                                      std::string context,
                                      uint64_t imsi,
                                      uint16_t cellid,
                                      uint16_t rnti);
     ...
     * \param rnti
     */
    static void NotifyConnectionReconfigurationEnb(RadioBearerStatsConnector* c,
                                                   std::string context,
                                                   uint64_t imsi,
                                                   uint16_t cellid,
                                                   uint16_t rnti);
     ...
     * \param targetCellId
     */
    static void NotifyHandoverStartEnb(RadioBearerStatsConnector* c,
                                       std::string context,
                                       uint64_t imsi,
                                       uint16_t cellid,
                                       uint16_t rnti,
     ...
     * \param rnti
     */
    static void NotifyHandoverEndOkEnb(RadioBearerStatsConnector* c,
                                       std::string context,
                                       uint64_t imsi,
                                       uint16_t cellid,
                                       uint16_t rnti);
  ...
  private:
    ...
    std::set<uint64_t>
        m_imsiSeenEnbSrb; //!< stores all eNBs for which RLC and PDCP traces and SRB1 were connected

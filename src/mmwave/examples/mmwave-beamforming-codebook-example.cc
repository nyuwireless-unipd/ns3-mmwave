...
main (int argc, char *argv[])
{
  ...
  ptr_mmWave->SetUeBeamformingCodebookAttribute ("CodebookFilename", StringValue ("src/mmwave/model/Codebooks/1x2.txt"));
  ...
  // 1. specify the path of the file containing the codebook
  ptr_mmWave->SetEnbBeamformingCodebookAttribute ("CodebookFilename", StringValue ("src/mmwave/model/Codebooks/8x8.txt"));

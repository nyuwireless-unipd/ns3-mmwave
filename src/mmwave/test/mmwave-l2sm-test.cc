...
{
public:
  MmWaveL2smEesmTestCase (const std::string &name) : TestCase (name) { }
...
{
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (3200, 18), MmWaveEesmErrorModel::SECOND,
                         "TestBgType1-a: The calculated value differs from the 3GPP base graph selection algorithm.");
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (3900, 18), MmWaveEesmErrorModel::FIRST,
                         "TestBgType1-b: The calculated value differs from the 3GPP base graph selection algorithm.");
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (200, 18), MmWaveEesmErrorModel::SECOND,
                         "TestBgType1-c: The calculated value differs from the 3GPP base graph selection algorithm.");
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (4000, 0), MmWaveEesmErrorModel::SECOND,
                         "TestBgType1-d: The calculated value differs from the 3GPP base graph selection algorithm.");
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (3200, 28), MmWaveEesmErrorModel::FIRST,
                         "TestBgType1-e: The calculated value differs from the 3GPP base graph selection algorithm.");
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (3200, 2), MmWaveEesmErrorModel::SECOND,
                         "TestBgType2-f: The calculated value differs from the 3GPP base graph selection algorithm.");
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (3200, 16), MmWaveEesmErrorModel::SECOND,
                         "TestBgType2-g: The calculated value differs from the 3GPP base graph selection algorithm.");
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (3900, 14), MmWaveEesmErrorModel::FIRST,
...
{
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (3200, 18), MmWaveEesmErrorModel::FIRST,
  ...
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (3200, 27), MmWaveEesmErrorModel::FIRST,
                         "TestBgType2-e: The calculated value differs from the 3GPP base graph selection algorithm.");
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (3200, 2), MmWaveEesmErrorModel::SECOND,
                         "TestBgType2-f: The calculated value differs from the 3GPP base graph selection algorithm.");
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (3200, 16), MmWaveEesmErrorModel::FIRST,
                         "TestBgType2-g: The calculated value differs from the 3GPP base graph selection algorithm.");
  NS_TEST_ASSERT_MSG_EQ (em->GetBaseGraphType (3900, 14), MmWaveEesmErrorModel::FIRST,
                         "TestBgType2-h: The calculated value differs from the 3GPP base graph selection algorithm.");
}

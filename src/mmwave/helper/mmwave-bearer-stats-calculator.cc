...
void
MmWaveBearerStatsCalculator::UlTxPdu(uint16_t cellId,
                                     uint64_t imsi,
                                     uint16_t rnti,
                                     uint8_t lcid,
                                     uint32_t packetSize)
...
void
MmWaveBearerStatsCalculator::DlTxPdu(uint16_t cellId,
                                     uint64_t imsi,
                                     uint16_t rnti,
                                     uint8_t lcid,
                                     uint32_t packetSize)
...
void
MmWaveBearerStatsCalculator::UlRxPdu(uint16_t cellId,
                                     uint64_t imsi,
                                     uint16_t rnti,
                                     uint8_t lcid,
                                     uint32_t packetSize,
...
void
MmWaveBearerStatsCalculator::DlRxPdu(uint16_t cellId,
                                     uint64_t imsi,
                                     uint16_t rnti,
                                     uint8_t lcid,
                                     uint32_t packetSize,
...
MmWaveBearerStatsCalculator::ShowResults(void)
{
    ...
    NS_LOG_INFO("Write stats in " << GetUlOutputFilename().c_str() << " and in "
...
MmWaveBearerStatsCalculator::RescheduleEndEpoch(void)
{
    ...
    m_endEpochEvent = Simulator::Schedule(m_startTime + m_epochDuration,
                                          &MmWaveBearerStatsCalculator::EndEpoch,
                                          this);
}

...
MmWaveRadioEnergyModel::GetTypeId (void)
{
    static TypeId tid = TypeId ("ns3::MmWaveRadioEnergyModel")
        ...
        .AddAttribute ("SleepA",
                        "The default Sleep Current in Amperes.",
                        DoubleValue (0.045),
                        MakeDoubleAccessor (&MmWaveRadioEnergyModel::SetSleepA,
                                            &MmWaveRadioEnergyModel::GetSleepA),
...
double 
MmWaveRadioEnergyModel::GetSleepA (void) const
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveRadioEnergyModel::SetSleepA (double SleepA)
{
  NS_LOG_FUNCTION (this << SleepA);
  m_SleepCurrentA = SleepA;
}
